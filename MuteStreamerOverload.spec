...
a = Analysis(
    ...
    hiddenimports=['PyQt6', 'PyQt6.sip', 'PyQt6.QtCore', 'PyQt6.QtGui', 'PyQt6.QtWidgets', 'PyQt6.QtSvg', 'flask', 'flask_socketio', 'engineio.async_drivers.threading', 'werkzeug', 'jinja2', 'requests', 'keyboard', 'multiprocessing'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
